...
import com.walmart.analytics.platform.notifier.ErrorHandler;
import com.walmart.analytics.platform.notifier.NotificationGroupClient;
import com.walmart.analytics.platform.notifier.NotifierClient;
import com.walmart.analytics.platform.notifier.exception.NotificationException;
import com.walmart.analytics.platform.notifier.model.Notification;
import com.walmart.analytics.platform.notifier.model.Notification.Status;
import com.walmart.analytics.platform.notifier.model.NotificationConfiguration;
import com.walmart.analytics.platform.notifier.mybatis.UserDataMapper;
...
public class RedisNotifierClient implements NotifierClient, NotificationGroupClient {
    ...
    public void updateStatus(ErrorHandler onError, String[] notificationIds,
        String user, Status updatedStatus) {
     ...
     */
    private void updateStatusWithException(String[] notificationIds, String user, Status status)
    ...
    private boolean shouldDelete(Notification notification) {
        ...
        return notification.getExpiryAt().compareTo(now) <= 0
            || notification.getStatus() == Status.DELETED;
    }
